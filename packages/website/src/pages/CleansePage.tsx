            ...
            <AnimatePresence mode="wait">
              ...
              {downloadState === 'ready' && release && (
                <motion.div key="ready" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-gray-600 text-xs font-mono">{release.tag_name}</p>
                  <p className="text-gray-600 text-xs max-w-sm leading-relaxed">
                    Not sure? Click <span className="text-gray-400"></span> &rarr; <span className="text-gray-400">About This Mac</span>.<br />
